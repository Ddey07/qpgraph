...
static SEXP
  qp_fast_ipf(SEXP vv, SEXP cliq, SEXP tol, SEXP verbose, SEXP iter);
...
static R_CallMethodDef
  callMethods[] = {
    ...
    {"qp_fast_ipf", (DL_FUNC) &qp_fast_ipf, 5},
...
static SEXP
  qp_fast_ipf(SEXP vvR, SEXP clqlstR, SEXP tolR, SEXP verbose, SEXP iterR) {
